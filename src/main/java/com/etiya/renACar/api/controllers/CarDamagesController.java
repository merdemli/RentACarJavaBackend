...
public class CarDamagesController {
    ...
    public List<CarDamageListResponse>getAllPaged(@RequestParam(value ="pageNo") int pageNo,
                                                  @RequestParam(value="pageSize") int pageSize){
        return this.carDamageService.getAllPaged(pageNo,pageSize);
    }

    @GetMapping("/getallsorted")
    public List<CarDamageListResponse>getAllSorted(@RequestParam(value="sort") boolean sort,
